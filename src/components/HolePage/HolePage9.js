...
class HolePage9 extends Component {
    ...
    componentDidMount() {
        ...
        // console.log('Page mounted', this.props.disc);
...
handleMinusClick = (playerNumber) => () => {
    ...
    nextHole = () => {
        ...
        for (let i = 0; i < this.props.playerReducer.length; i++) {
            ...
            gameData={strokes:this.state[i], score: score, playerID:playerID, gameID: this.props.gameIDReducer, hole:'hole_9'}
...
export default connect(mapStateToProps)(HolePage9);