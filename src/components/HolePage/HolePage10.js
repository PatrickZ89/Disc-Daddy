...
class HolePage10 extends Component {
...
handleMinusClick = (playerNumber) => () => {
    ...
    nextHole = () => {
        ...
        for (let i = 0; i < this.props.playerReducer.length; i++) {
            ...
            gameData={strokes:this.state[i], score: score, playerID:playerID, gameID: this.props.gameIDReducer, hole:'hole_10'}
...
export default connect(mapStateToProps)(HolePage10);