...
class HolePage15 extends Component {
    ...
    nextHole = () => {
        ...
        for (let i = 0; i < this.props.playerReducer.length; i++) {
            ...
            gameData={strokes:this.state[i], score: score, playerID:playerID, gameID: this.props.gameIDReducer, hole:'hole_15'}
...
export default connect(mapStateToProps)(HolePage15);